...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="m29.55 10.665-.993-.991a1.54 1.54 0 0 0-2.178 0l-.927.928 3.169 3.17.928-.928c.6-.602.6-1.577 0-2.179ZM16.76 19.287v3.17h3.17l7.827-7.829-3.17-3.169-7.827 7.828ZM9.347 9.934h8.952v1.492H9.347zM9.347 15.398h8.952v1.492H9.347zM9.366 20.863h5.47v1.492h-5.47z"
    />
    <path
      fill="currentColor"
